  ...
  return (
    <div className="font-sans">
      <div className="max-w-[1200px] w-full flex flex-col items-center m-auto px-4">
        <h1 className="text-3xl sm:text-5xl lg:leading-15 leading-10 font-semibold mt-8 lg:mt-12 mb-5 text-center">Track Your Health With an Easy BMI Calculator</h1>
        <h2 className="text-sm sm:text-lg lg:leading-8 leading-5 font-medium text-center px-4 sm:px-20 mb-6 lg:mb-10">Body Mass Index (BMI) is a quick way to estimate whether your weight is in a healthy range for your height. While it works the same for adult men and women, BMI doesn’t tell the full story — it doesn’t account for muscle, bone strength, or overall body composition. Think of it as a starting point, not the final answer. For a complete picture of your health, always pair your BMI with professional medical advice.</h2>
